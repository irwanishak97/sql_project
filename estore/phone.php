...
<html lang="en">
    ...
    <!--<body>-->
        <div class="container">
            <br><h4 style="font-style: italic;">Mobile Phones</h4><br><br>
            <?php foreach($devices as $device): ?>
                <ul class="collection with-header">
                    <li class="collection-header"><h5><?php echo htmlspecialchars($device['model_name']);?></h5></li>
                    <li class="collection-item avatar">
                        <i class="material-icons circle  blue-grey lighten-3">smartphone</i>
            ...
            <?php endforeach; ?>
            <a href="add_device.php" class="waves-effect waves-light btn right" style="margin:5px;">Add Phone</a>
            <a href="index.php" class="waves-effect waves-light btn right" style="margin:5px;">Back</a><br><br><br><br>
        </div>
    <!--</body>-->
